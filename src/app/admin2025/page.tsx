...
export default function AdminLoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                router.push('/admin2025/dashboard');
            } else {
        ...
        <div className="min-h-screen flex flex-col lg:flex-row">
            ...
            <div className="lg:hidden w-full h-64 sm:h-80 relative">
                ...
                <div className="relative z-10 flex items-center justify-center h-full">
                    <div className="text-center text-white">
                        <h1 className="text-2xl sm:text-3xl font-bold mb-2 sm:mb-4">Admin Portal</h1>
                        <h2 className="text-3xl sm:text-4xl font-bold mb-2 sm:mb-4">Sandip University</h2>
                        <p className="text-sm sm:text-lg opacity-90">Administrative Dashboard</p>
                    </div>
                </div>
            </div>
            ...
            <div className="hidden lg:block lg:w-[70%] relative">
                ...
                <div className="relative z-10 flex items-center justify-center h-full">
                    <div className="text-center text-white">
                        ...
                        <p className="text-xl opacity-90">Administrative Dashboard</p>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full lg:w-[30%] bg-slate-50 flex items-center justify-center p-4 sm:p-6 lg:p-8 flex-1">
                <div className="w-full max-w-sm sm:max-w-md">
                    {/* Logo and Header */}
                    <motion.div
                        className="flex items-center gap-3 sm:gap-4 justify-center mb-6 sm:mb-8"
                        ...
                        <Card className="bg-white border border-slate-200 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                            ...
                            <CardContent className="px-4 sm:px-6">
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    ...
                                    {error && (
                                        <motion.div
                                            className="p-3 rounded-md bg-red-50 border border-red-200 text-red-700 text-sm sm:text-base"
